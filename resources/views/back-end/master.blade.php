...
<head>
   ...
   <script src="{{ asset('/') }}ck-editor/samples/js/sample.js"></script> 
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                @include('back-end.includes.top-nav')
                <!-- End of Topbar -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{ route('userLogout') }}">Logout</a>
                </div>
            </div>
        </div>
    </div>
